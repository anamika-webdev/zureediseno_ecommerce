...
export const metadata: Metadata = {
  title: 'Shop All Collections - Premium Fashion',
  description: 'Browse our complete collection of premium clothing for men, women, and kids. Discover exclusive designs, custom tailoring, and bulk order options. Free shipping on orders over ₹2000.',
  keywords: ['shop fashion', 'buy clothes online', 'fashion store', 'online shopping', 'mens clothing', 'womens fashion', 'kids wear'],
  openGraph: {
    title: 'Shop All Collections - Zuree Diseno',
    description: 'Browse our complete collection of premium clothing for men, women, and kids.',
    url: '/shop',
    images: [
      {
        url: '/og-shop.jpg',
